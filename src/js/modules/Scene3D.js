...
export default class Scene3D {
  ...
  constructor() {
    ...
    const frustumSize = 700 // Puoi regolare questa dimensione per adattarla alla tua scena
    const near = 0.1
    const far = 1000
    ...
    // })
    // this.camera = new THREE.CubeCamera(10, 1000, cubeRenderTarget)
    // this.camera.position.set(20, 0, 300)
    this.camera.position.set(0, 0, 300)
    // this.camera.lookAt(new THREE.Vector3(0, 200, 300))
  ...
  #createLights() {
    ...
    this.directionaLight1 = new THREE.DirectionalLight(0xffffff, 2)
  ...
  #createBubble() {
    ...
    this.bubbleMaterial = new THREE.MeshPhysicalMaterial({
      ...
      //   'src/materials/obsidian/Obsidian_001_ambientOcclusion.jpeg'
      // ),
      // aoMapIntensity: 1,
      color: 0x020410,
      // displacementMap: this.textureLoader.load(
      //   'src/materials/obsidian/Obsidian_001_height.png'
      // ),
      // displacementScale: 0,
      // emissive: 0x000000,
      // envMap: this.textureLoader.load(
      //   'src/materials/obsidian/obsidian-pavement-texture_9939242.jpg'
      // ),
      // emissiveIntensity: 1,
      ...
      //   'src/materials/obsidian/Obsidian_001_normal.jpeg'
      // ),
      roughness: 1,
      // roughnessMap: this.textureLoader.load(
      //   'src/materials/obsidian/Obsidian_001_roughness.jpeg'
      // ),
      // shininess: 100,
  ...
  #updateBubbleVertices(time) {
    ...
    for (
      ...
      const ratio =
        this.#ratioScalingFactor * perlin * (Math.sin(timeTmp / 1000) + 1.1) +
        this.#ratioOffset
  ...
  animate(time) {
    ...
    this.bubble.rotation.y =
      (-4 * math.mapRange(this.#mouse.x, 0, window.innerWidth, 0, 4)) / 10
